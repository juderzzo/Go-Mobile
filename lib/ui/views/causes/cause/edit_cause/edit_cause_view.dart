...
class EditCauseView extends StatelessWidget {
  ...
  EditCauseView(
      {this.causeID, this.name, this.goals, this.why, this.who, this.resources, this.charity, this.img1, this.img2, this.img3, this.videoLink, this.monetized});
  ...
  Widget imgBtn(BuildContext context, EditCauseViewModel model, int imgNum) {
    ...
    return Stack(children: [
      model.isEditing
          ...
          ? AddImageButton(
              onTap: () async {
                await model.selectImage(context: context, imgNum: imgNum, ratioX: width, ratioY: height);
              },
              iconSize: iconSize,
              height: height,
              width: width,
          ...
          : CauseImgPreview(
              onTap: () {
                print(1);
                model.selectImage(context: context, imgNum: imgNum, ratioX: width, ratioY: height);
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<EditCauseViewModel>.reactive(
      ...
      builder: (context, model, child) => Scaffold(
        appBar: CustomAppBar().basicAppBar(title: "Edit Cause", showBackButton: true) as PreferredSizeWidget?,
