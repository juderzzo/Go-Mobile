      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            Spacer(),
            IconButton(
                icon: !show ? Icon(Icons.arrow_left) : Icon(Icons.arrow_drop_down),
                onPressed: () {
                  model!.showTake(index, model);
                })
          ],
        ),
      ),
                    ...
                    children: [
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Container(
                                        child: Text(
                                      "\$${(cause!.revenue! * 0.564 / 1000).toStringAsFixed(2)}",
                                      style: TextStyle(
                                        fontSize: 18,
                                        fontWeight: FontWeight.bold,
                                        color: isDarkMode() ? Colors.green[600] : Colors.green,
                      ...
                      model.showAdmins
                          ? Column(
                              children: [
                                Container(
                                    height: MediaQuery.of(context).size.height * 1.5 / 5, width: MediaQuery.of(context).size.width * 5 / 6, child: Admins()),
