...
import 'package:go/ui/bottom_sheets/content_bottom_sheets/add_content_bottom_sheet/add_post_bottom_sheet/add_post_bottom_sheet.dart';
...
import 'content_bottom_sheets/add_content_bottom_sheet/add_cause_bottom_sheet/add_cause_bottom_sheet.dart';
...
void setupBottomSheetUI() {
  ...
  final builders = {
    ...
    BottomSheetType.addCause: (context, sheetRequest, completer) => AddCauseBottomSheet(request: sheetRequest, completer: completer),
    ...
    BottomSheetType.addPost: (context, sheetRequest, completer) => AddPostBottomSheet(request: sheetRequest, completer: completer),
